...
public class StartHelper {
	public static void printHelper(){
		System.out.println("3 types of command are available: ADD_NEWS, FIND_NEWS, EXIT");
		System.out.println("In the 1st line enter the COMMAND. In the 2d - string in valid format (below there are examples of valid string, between [] symbols). ");
		System.out.println("");
		...
		System.out.println("");
		System.out.println("To end the program enter the command EXIT and press ENTER twice.");
		System.out.println("        =======================================");
		System.out.println("");
	}
}
